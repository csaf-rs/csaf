...
pub fn test_6_1_41_missing_sharing_group_name(doc: &impl CsafTrait) -> Result<(), ValidationError> {
...
mod tests {
    ...
    use crate::csaf::validation::ValidationError;
    use crate::csaf::validations::test_6_1_41::{
        SG_NAME_PRIVATE, SG_NAME_PUBLIC, test_6_1_41_missing_sharing_group_name,
    };
