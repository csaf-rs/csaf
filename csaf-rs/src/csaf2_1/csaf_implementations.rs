...
use crate::csaf2_1::schema::{
    Branch, CategoryOfPublisher, CategoryOfTheRemediation, CommonSecurityAdvisoryFramework, Content,
    ...
    Metric, Note, PartyCategory, ProductGroup, ProductStatus, ProductTree, Publisher, Relationship, Remediation,
