...
impl Validatable for CommonSecurityAdvisoryFramework {
    ...
    fn run_test(&self, test_id: &str) -> TestResult {
        let mandatory_result = to_test_result(
            ...
            match test_id {
                // mandatory tests
                "6.1.1" => None, // Some(ValidatorForTest6_1_1.validate(self)), // TODO: re-enable after fixing
                "6.1.2" => Some(ValidatorForTest6_1_2.validate(self)),
                "6.1.3" => None, // Some(ValidatorForTest6_1_3.validate(self)), // TODO: re-enable after fixing
                "6.1.4" => None, // Some(ValidatorForTest6_1_4.validate(self)), // TODO: re-enable after fixing
                ...
                "6.1.25" => None, // Some(ValidatorForTest6_1_25.validate(self)), // TODO: re-enable after fixing
