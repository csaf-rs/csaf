...
///  "type": "string",
///  "pattern": "^6\\.(([1-3]\\.[1-9])|(1\\.10)|([12]\\.1[1-9])|(3\\.1[0-8])|(3\\.19\\.[1-5])|([12]\\.2[0-6])|(2\\.27)|([12]\\.2[8-9])|(1\\.27\\.([1-9]|1[0-9]|20))|(3\\.20)|(3\\.21\\.[1-9])|(3\\.22)|(3\\.23\\.[12])|(3\\.24)|([12]\\.3[0-8])|(1\\.39)|(2\\.39\\.([1-9]|1[0-3]))|([12]\\.4[0-9])|(1\\.5[0-9])|(2\\.50\\.[1-3])|(2\\.5[1-3])|(2\\.54\\.[1-4])|(2\\.55)|(1\\.60\\.[1-3])|(1\\.6[12]))$"
///}
/// ```
/// </details>
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
...
impl ::std::str::FromStr for NumberOfTheTest {
    ...
    fn from_str(
        ...
        {
            ::regress::Regex::new(
                    "^6\\.(([1-3]\\.[1-9])|(1\\.10)|([12]\\.1[1-9])|(3\\.1[0-8])|(3\\.19\\.[1-5])|([12]\\.2[0-6])|(2\\.27)|([12]\\.2[8-9])|(1\\.27\\.([1-9]|1[0-9]|20))|(3\\.20)|(3\\.21\\.[1-9])|(3\\.22)|(3\\.23\\.[12])|(3\\.24)|([12]\\.3[0-8])|(1\\.39)|(2\\.39\\.([1-9]|1[0-3]))|([12]\\.4[0-9])|(1\\.5[0-9])|(2\\.50\\.[1-3])|(2\\.5[1-3])|(2\\.54\\.[1-4])|(2\\.55)|(1\\.60\\.[1-3])|(1\\.6[12]))$",
                )
                .unwrap()
        });
        if PATTERN.find(value).is_none() {
            return Err(
                "doesn't match pattern \"^6\\.(([1-3]\\.[1-9])|(1\\.10)|([12]\\.1[1-9])|(3\\.1[0-8])|(3\\.19\\.[1-5])|([12]\\.2[0-6])|(2\\.27)|([12]\\.2[8-9])|(1\\.27\\.([1-9]|1[0-9]|20))|(3\\.20)|(3\\.21\\.[1-9])|(3\\.22)|(3\\.23\\.[12])|(3\\.24)|([12]\\.3[0-8])|(1\\.39)|(2\\.39\\.([1-9]|1[0-3]))|([12]\\.4[0-9])|(1\\.5[0-9])|(2\\.50\\.[1-3])|(2\\.5[1-3])|(2\\.54\\.[1-4])|(2\\.55)|(1\\.60\\.[1-3])|(1\\.6[12]))$\""
                    .into(),
            );
        }
        Ok(Self(value.to_string()))
