...
///  "type": "string",
///  "pattern": "^6\\.(([1-3]\\.[1-9])|(1\\.10)|([12]\\.1[1-9])|(3\\.1[0-8])|([12]\\.2[0-6])|(2\\.27)|([12]\\.2[8-9])|(1\\.27\\.([1-9]|1[0-9]))|([12]\\.3[0-8])|(1\\.39)|(2\\.39\\.[1-4])|(1\\.4[0-9])|(2\\.4[0-8])|(1\\.5[0-6]))$"
///}
/// ```
/// </details>
#[derive(::serde::Serialize, Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
...
impl ::std::str::FromStr for NumberOfTheTest {
    ...
    fn from_str(
        ...
        {
            ::regress::Regex::new(
                    "^6\\.(([1-3]\\.[1-9])|(1\\.10)|([12]\\.1[1-9])|(3\\.1[0-8])|([12]\\.2[0-6])|(2\\.27)|([12]\\.2[8-9])|(1\\.27\\.([1-9]|1[0-9]))|([12]\\.3[0-8])|(1\\.39)|(2\\.39\\.[1-4])|(1\\.4[0-9])|(2\\.4[0-8])|(1\\.5[0-6]))$",
                )
                .unwrap()
        });
        if PATTERN.find(value).is_none() {
            return Err(
                "doesn't match pattern \"^6\\.(([1-3]\\.[1-9])|(1\\.10)|([12]\\.1[1-9])|(3\\.1[0-8])|([12]\\.2[0-6])|(2\\.27)|([12]\\.2[8-9])|(1\\.27\\.([1-9]|1[0-9]))|([12]\\.3[0-8])|(1\\.39)|(2\\.39\\.[1-4])|(1\\.4[0-9])|(2\\.4[0-8])|(1\\.5[0-6]))$\""
                    .into(),
            );
        }
        Ok(Self(value.to_string()))
