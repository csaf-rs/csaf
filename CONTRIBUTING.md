...
1. **Search existing issues** [open and closed](https://github.com/csaf-rs/csaf/issues?q=is%3Aissue%20(state%3Aopen%20OR%20state%3Aclosed)) or [discussions](https://github.com/orgs/csaf-rs/discussions) to avoid duplicates.
2. **Use the correct template** — [defect reports](https://github.com/csaf-rs/csaf/issues/new?template=defect_report.md) and [feature requests](https://github.com/csaf-rs/csaf/issues/new?template=feature_request.md) 
