...
/// namespace is not an unregistered one if the document is not labeled TLP:CLEAR. Namespaces
...
mod tests {
    use super::*;
    use crate::csaf2_1::testcases::ExpectedResults_6_3_14 as ExpectedResults;
