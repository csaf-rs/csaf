    ...
    fn test_6_1_01() {
        ...
        TESTS_2_1.test_6_1_1.expect(
            ...
            Err(vec![
                ...
                generate_err_msg("CSAFPID-9080704", "/document/notes/0/product_ids/4"),
                generate_err_msg("CSAFPID-9080704", "/vulnerabilities/0/flags/0/product_ids/0"),
                generate_err_msg("CSAFPID-9080701", "/vulnerabilities/0/threats/0/product_ids/1"),
                generate_err_msg("CSAFPID-9080701", "/vulnerabilities/0/remediations/0/product_ids/1"),
                generate_err_msg("CSAFPID-9080702", "/vulnerabilities/0/remediations/0/product_ids/2"),
                generate_err_msg("CSAFPID-9080710", "/vulnerabilities/0/product_status/first_affected/0"),
                generate_err_msg("CSAFPID-9080703", "/vulnerabilities/0/product_status/first_fixed/0"),
                generate_err_msg("CSAFPID-9080704", "/vulnerabilities/0/product_status/fixed/0"),
                generate_err_msg("CSAFPID-9080701", "/vulnerabilities/0/product_status/known_affected/0"),
                generate_err_msg(
                    "CSAFPID-9080715",
                    "/vulnerabilities/0/product_status/known_not_affected/0",
                ),
                generate_err_msg("CSAFPID-9080702", "/vulnerabilities/0/product_status/last_affected/0"),
                generate_err_msg("CSAFPID-9080704", "/vulnerabilities/0/product_status/recommended/0"),
                generate_err_msg(
                    "CSAFPID-9080706",
                    "/vulnerabilities/0/product_status/under_investigation/0",
                ),
                generate_err_msg("CSAFPID-9080707", "/vulnerabilities/0/product_status/unknown/0"),
                generate_err_msg("CSAFPID-9080708", "/vulnerabilities/0/product_status/unknown/1"),
                generate_err_msg("CSAFPID-9080701", "/vulnerabilities/0/metrics/0/products/1"),
                generate_err_msg("CSAFPID-9080702", "/vulnerabilities/0/metrics/0/products/2"),
                generate_err_msg("CSAFPID-9080701", "/vulnerabilities/0/notes/0/product_ids/1"),
                generate_err_msg("CSAFPID-9080702", "/vulnerabilities/0/notes/0/product_ids/2"),
                generate_err_msg("CSAFPID-9080701", "/vulnerabilities/0/involvements/0/product_ids/1"),
                generate_err_msg("CSAFPID-9080702", "/vulnerabilities/0/involvements/0/product_ids/2"),
                generate_err_msg(
                    "CSAFPID-9080701",
                    "/vulnerabilities/0/first_known_exploitation_dates/0/product_ids/1",
                ),
                generate_err_msg("CSAFPID-9080701", "/product_tree/product_groups/0/product_ids/1"),
                generate_err_msg("CSAFPID-9080702", "/product_tree/product_groups/0/product_ids/2"),
                generate_err_msg("CSAFPID-9080703", "/product_tree/product_groups/0/product_ids/3"),
                generate_err_msg("CSAFPID-9080704", "/product_tree/product_groups/0/product_ids/4"),
                generate_err_msg(
                    "CSAFPID-9080715",
                ...
                generate_err_msg(
                    "CSAFPID-9080701",
                    "/product_tree/product_paths/1/beginning_product_reference",
                ),
                generate_err_msg(
                    "CSAFPID-9080702",
                    "/product_tree/product_paths/2/beginning_product_reference",
                ),
                generate_err_msg(
                    "CSAFPID-9080715",
