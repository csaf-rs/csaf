...
pub fn sort_revision_history_tuples_by_date_by_number(tuples: &mut [RevisionHistoryTupleType]) {
...
pub fn sort_revision_history_tuples_by_number(tuples: &mut [RevisionHistoryTupleType]) {
