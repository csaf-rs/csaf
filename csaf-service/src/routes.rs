...
pub const VALIDATE_FILE: &str = "/api/v1/csaf/{version}/validate/file";
pub const VALIDATE_AUTO: &str = "/api/v1/csaf/validate";
pub const VALIDATE_FILE_AUTO: &str = "/api/v1/csaf/validate/file";
