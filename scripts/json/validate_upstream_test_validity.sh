...
CSAF_2_0_TESTCSAES_JSON="$REPO_ROOT/csaf/csaf_2.0/test/validator/data/testcases.json"
...
python3 "$REPO_ROOT/scripts/json/validate_testcases_json_validity.py" "$VALIDATOR_PATH" "$CSAF_2_0_TESTCSAES_JSON" "2.0"
