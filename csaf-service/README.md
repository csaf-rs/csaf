...
| `CSAF_SERVICE_BODY_LIMIT` | The maximum request body size in bytes. Values exceeding this limit are clamped to the maximum. Limited to 150 MB as requested by the standard. | `157286400` (150 MB) |
